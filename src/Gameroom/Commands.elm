module Gameroom.Commands exposing (..)
...
commandEncoder : (problem -> JE.Value) -> (guess -> JE.Value) -> Command problem guess -> JE.Value
commandEncoder problemEncoder guessEncoder cmd =
    case cmd of
        CreateRoom room ->
            JE.object
